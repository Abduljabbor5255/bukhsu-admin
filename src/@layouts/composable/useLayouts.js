...
export const useLayouts = () => {
  ...
  /*
      ...
      ℹ️ We are getting `isVerticalNavHovered` as param instead of via `inject` because
          we are using this in `VerticalNav.vue` components which provide it and I guess because
          same components is providing & injecting we are getting undefined error
    */
